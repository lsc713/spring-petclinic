...
class OwnerCacheStampedeChaosTests {

	@Autowired
	private MockMvc mockMvc;

	@MockitoBean
	private CacheStampede cacheStampede;

	@MockitoBean
	private OwnerRepository owners;

	@Test
	void ownerSearchInvokesCacheStampede() throws Exception {
		...
		// the search path must route through the cache-stampede seam (mock here, so no
		// real
		// recompute runs)
		verify(this.cacheStampede).getOrLoadIfArmed();
	}
