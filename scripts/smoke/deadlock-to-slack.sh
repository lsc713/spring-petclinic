...
echo "(one-shot: the spawned deadlock persists for the app's lifetime — restart the app to"
echo " clear it. Disarm (curl -s -XPOST $APP/chaos/deadlock/disarm) only prevents re-triggering.)"
